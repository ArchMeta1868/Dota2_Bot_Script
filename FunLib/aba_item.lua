...
if true then
	...
	Item['item_phase_boots']           = GetItemComponents('item_phase_boots')[1]
	Item['item_pipe']                  = GetItemComponents('item_pipe')[1]
	Item['item_power_treads_agi']      = GetItemComponents('item_power_treads_agi')[1]
	Item['item_power_treads_int']      = GetItemComponents('item_power_treads_int')[1]
	Item['item_power_treads_str']      = GetItemComponents('item_power_treads_str')[1]
	Item['item_power_treads']          = GetItemComponents('item_power_treads')[1]
	...
	Item['item_ultimate_scepter']      = GetItemComponents('item_ultimate_scepter')[1]
	...
	Item['item_yasha']                 = GetItemComponents('item_yasha')[1]
	...
	Item['item_trident']               = GetItemComponents('item_trident')[1]
	Item['item_lunar_crest']           = GetItemComponents('item_lunar_crest')[1]
end
